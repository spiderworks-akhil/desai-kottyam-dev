...
import FloorPlan1 from "@/public/img/city-gate-typical-updated.webp";
import FloorPlan2 from "@/public/img/city-gate-planA.webp";
import FloorPlan3 from "@/public/img/city-gate-planB.webp";
import FloorPlan4 from "@/public/img/city-gate-planC.webp";
import FloorPlan5 from "@/public/img/city-gate-planD.webp";
import FloorPlan6 from "@/public/img/city-gate-planE.webp";
import FloorPlan7 from "@/public/img/city-gate-planF.webp";
import FloorPlan8 from "@/public/img/city-gate-planG.webp";
import FloorPlan9 from "@/public/img/city-gate-planH.webp";
...
export default function BasicModal() {
  ...
  const FlooPlanM = () => setOpenM(true);
  const handleCloseM = () => setOpenM(false);
  const FlooPlanN = () => setOpenN(true);
  const handleCloseN = () => setOpenN(false);
  const FlooPlanO = () => setOpenO(true);
        ...
        <SwiperSlide className="relative">
          ...
          <div className="floor-plan-text ">
            ...
            <Modal
              ...
              aria-describedby="modal-modal-description"
            >
              <Box sx={style} className="max-w-[1000px] w-full">
