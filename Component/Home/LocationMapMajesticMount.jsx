...
import MapLocation from '@/public/img/location-map-updated.webp';
    ...
    return(
        ...
        <div className='location-block lg:flex gap-5 md:flex md:flex-row sm:flex-col '>
            <div className="location-map w-[100%] md:w-[50%] m-[0px_0px_20px]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3933.878127880056!2d76.53126801533074!3d9.605761182332149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b062b6e63f076af%3A0xae92e3d4b094903e!2sDD%20Majestic%20Mount!5e0!3m2!1sen!2sin!4v1679648491922!5m2!1sen!2sin" width="100%" height="420" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
