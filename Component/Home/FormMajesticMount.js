      ...
      <div className="">
        ...
        <div className="form-input-block">
          <div className="relative w-full bg-[#0D2C4A]">
            ...
            >
              ...
              <option>DD Legacy Heights (Starts from 58Lakh)</option>
              <option>DD Majestic Mount (Starts from 59Lakh)</option>


            </select>
          </div>
          <p className="text-red-500 mt-1 text-[12px]">{errors.project?.message}</p>
        </div>
        ...
        <div className="form-input-block">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="14"
            height="15" viewBox="0 0 24 24" fill="none">  <path d="M11.9999 14.1699C9.86988 14.1699 8.12988 12.4399 8.12988 10.2999C8.12988 8.15994 9.86988 6.43994 11.9999 6.43994C14.1299 6.43994 15.8699 8.16994 15.8699 10.3099C15.8699 12.4499 14.1299 14.1699 11.9999 14.1699ZM11.9999 7.93994C10.6999 7.93994 9.62988 8.99994 9.62988 10.3099C9.62988 11.6199 10.6899 12.6799 11.9999 12.6799C13.3099 12.6799 14.3699 11.6199 14.3699 10.3099C14.3699 8.99994 13.2999 7.93994 11.9999 7.93994Z" fill="#16CC70"></path><path d="M11.9999 22.76C10.5199 22.76 9.02993 22.2 7.86993 21.09C4.91993 18.25 1.65993 13.72 2.88993 8.33C3.99993 3.44 8.26993 1.25 11.9999 1.25C11.9999 1.25 11.9999 1.25 12.0099 1.25C15.7399 1.25 20.0099 3.44 21.1199 8.34C22.3399 13.73 19.0799 18.25 16.1299 21.09C14.9699 22.2 13.4799 22.76 11.9999 22.76ZM11.9999 2.75C9.08993 2.75 5.34993 4.3 4.35993 8.66C3.27993 13.37 6.23993 17.43 8.91993 20C10.6499 21.67 13.3599 21.67 15.0899 20C17.7599 17.43 20.7199 13.37 19.6599 8.66C18.6599 4.3 14.9099 2.75 11.9999 2.75Z" fill="#16CC70"></path></svg>
        </div>
        ...
        {/* <div className="relative w-full bg-[#0D2C4A]">
          ...
          <select
            ...
            {...register("price_range", {
              required: "Price Range is requried",
            })}
        ...
        </div>      <p className="text-red-500 mt-1 text-[12px]">{errors.price_range?.message}</p> */}
        <button className="submit-btn bg-[#1CC273] text-[#fff] text-[18px] font-[700] p-3 w-full mt-5">
          {loading ? (<>
