      ...
      <div className="Specifications-list-block grid md:grid-cols-3 sm:grid-cols-2 gap-[30px]">
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              ...
              apartment and putty finished ceiling in drawing and dining hall.
            </p>
          </div>
        </div>
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              Jaquar or equivalent and Sanitary Fittings - Cera or equivalent
            </p>
          </div>
        </div>
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              ...
              Flush Doors and powder coated Aluminium Windows with Glass &
              Grill.
            </p>
          </div>
        </div>
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              32 Amps A/c. point-3 points for 3 BHK flat and 2 points for 2BHK
              flat.
            </p>
          </div>
        </div>
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              16 Amps plug point- 5 points per 3 BHK flat and 4 points per 2 BHK
