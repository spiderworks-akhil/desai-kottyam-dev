      ...
      <div className="Specifications-list-block grid md:grid-cols-3 sm:grid-cols-2 gap-[30px]">
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              Living, Dining, Kitchen Vitrified Tiles & Ceramic Tiles for
              Bedrooms, Toilet and Balconies.
            </p>
          </div>
        </div>
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              Anti-skid bathroom floor tiles with glazed wall tiles upto
              ceiling.
            </p>
          </div>
        </div>
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>Finolex or equivalent, MCB's and ELCB-Legrand or equivalent</p>
          </div>
        </div>
        <div className="Specifications-list-block-item">
          <div>
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
              Polished Front door fitted with Godrej or equivalent lock, inside
              paneled doors and powder coated aluminium windows with Glass and
              Grill.
            </p>
          </div>
        </div>
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
            32 Amps A/c. point-2 points for 2 & 3 BHK flats (Additional electrical point on request will be charged extra).
            </p>
          </div>
        </div>
        ...
        <div className="Specifications-list-block-item">
          <div>
            ...
            <p>
           16 Amps plug point- 4 points per 2 & 3 BHK flats , including Geyser point in all toilets.
            </p>
          </div>
        </div>
