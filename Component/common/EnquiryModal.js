  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (postResponse.data.status === "success") {
        ...
        // ✅ Open brochure in the pre-opened tab
        setTimeout(() => {
          const brochureTab = window.open("", "_blank");
          if (brochureUrl && brochureTab) {
            brochureTab.location.href = brochureUrl;
          }
        }, 1000);
                ...
                <div class="relative w-full project-select">
                  ...
                  >
                    {frm === "majestic_mount" && (
                      <>
                        <option selected>
                          DD Majestic Mount (Starts from 59Lakh)
                        </option>
                        <option>DD City Gate (Starts from 44Lakh)</option>
                        <option>
                          DD Legacy Heights (Starts from 49.5Lakh)
                        </option>
                      </>
                    )}
                    {frm === "city_gate" && (
                      <>
                        <option selected>
                          DD City Gate (Starts from 44Lakh)
                        </option>
